          ...
          <div class="card border-0 shadow mb-4">
            <div class="card-body">
                <div class="text-end mb-4">
                    <a href="?seen=all" class="btn btn-sm btn-dark rounded-pill shadow-none"><i class="bi bi-check-all me-2"></i>Mark All Read</a>
                    <a href="?del=all" class="btn btn-sm btn-danger rounded-pill shadow-none"><i class="bi bi-trash me-2"></i>Delete All</a>
                </div>
                ...
                <table class="table table-hover border">
                  ...
                  <tbody>
                    <?php
                        ...
                        $q = "SELECT rr.* , uc.name AS uname, r.name AS rname  FROM `rating_review` rr INNER JOIN `user_cred` uc ON rr.user_id = uc.id INNER JOIN `rooms` r ON rr.room_id = r.id ORDER BY `sr_no` DESC";
